...
const Head = () => (
  <Helmet>
    ...
    <meta property="og:image" content={`https://josuearce.com${withPrefix('favicons/og-image.jpg')}`} />
    ...
    <meta itemProp="image" content={`https://josuearce.com${withPrefix('favicons/og-image.jpg')}`} />
    ...
    <meta name="twitter:image" content={`https://josuearce.com${withPrefix('favicons/og-image.jpg')}`} />
